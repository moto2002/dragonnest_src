...
namespace XUtliPoolLib
{
	public class RandomAttributes : CVSReader
	{
		...
		public List<RandomAttributes.RowData> Table = new List<RandomAttributes.RowData>();
		...
		protected override bool OnLine(string[] Fields)
		{
			...
			if (!base.Parse(Fields[this.ColMap[3]], ref rowData.Prob))
			{
				return false;
			}
			...
			if (!base.Parse<int>(Fields[this.ColMap[6]], ref rowData.SmeltAttr1, CVSReader.intParse, "3I"))
			{
				return false;
			}
