...
public class UIToggle : UIWidgetContainer
{
	...
	private void Start()
	{
		...
		if (!Application.isPlaying)
		{
			...
			if (this.checkSprite2 != null && this.activeSprite2 == null)
			{
				this.activeSprite2 = this.checkSprite2;
				this.checkSprite2 = null;
			}
			...
			if (Application.isPlaying && this.activeSprite2 != null)
			{
				this.activeSprite2.alpha = ((!this.startsActive) ? 0f : 1f);
			}
