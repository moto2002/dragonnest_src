...
{
	[TaskCategory("Basic/Transform"), TaskDescription("Sets the local scale of the Transform. Returns Success.")]
	public class SetLocalScale : BehaviorDesigner.Runtime.Tasks.Action
	{
