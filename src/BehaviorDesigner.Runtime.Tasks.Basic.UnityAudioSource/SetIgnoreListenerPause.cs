...
{
	[TaskCategory("Basic/AudioSource"), TaskDescription("Sets the ignore listener pause value of the AudioSource. Returns Success.")]
	public class SetIgnoreListenerPause : BehaviorDesigner.Runtime.Tasks.Action
	{
