...
{
	[TaskCategory("Basic/Input"), TaskDescription("Stores the raw value of the specified axis and stores it in a float.")]
	public class GetAxisRaw : BehaviorDesigner.Runtime.Tasks.Action
	{
