...
{
	[HelpURL("http://www.opsive.com/assets/BehaviorDesigner/documentation.php?id=118"), TaskCategory("Basic/Physics2D"), TaskDescription("Casts a circle against all colliders in the scene. Returns success if a collider was hit.")]
	public class Circlecast : BehaviorDesigner.Runtime.Tasks.Action
	{
		...
		[SharedRequired, BehaviorDesigner.Runtime.Tasks.Tooltip("Stores the hit object of the circlecast.")]
		public SharedGameObject storeHitObject;

		[SharedRequired, BehaviorDesigner.Runtime.Tasks.Tooltip("Stores the hit point of the circlecast.")]
		public SharedVector2 storeHitPoint;

		[SharedRequired, BehaviorDesigner.Runtime.Tasks.Tooltip("Stores the hit normal of the circlecast.")]
		public SharedVector2 storeHitNormal;

		[SharedRequired, BehaviorDesigner.Runtime.Tasks.Tooltip("Stores the hit distance of the circlecast.")]
