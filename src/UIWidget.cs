...
public class UIWidget : UIRect
{
	...
	public BoxCollider boxColliderCache;

	public bool calcRenderQueue;
	...
	public bool isVisible
	{
		get
		{
			return this.mIsVisibleByPanel && this.mIsVisibleByAlpha && this.mIsInFront && this.finalAlpha > 0.001f && NGUITools.GetActive(this) && !this.isFaraway;
		}
	}
	...
	private bool isFaraway
	{
		get
		{
			return base.cachedTransform.localPosition.x == 2016f || base.cachedTransform.localPosition.y == 2016f;
		}
	}
	...
	public bool hasBoxCollider
	{
		get
		{
			return this.boxColliderCache != null;
		}
	}

	public BoxCollider DefaultBoxCollider
	{
		get
		{
			return this.boxColliderCache;
		}
	}
	...
	public void RegisterUI(Component c)
	{
	}
	...
	{
		if (NGUITools.GetActive(this) && this.boxColliderCache != null)
		{
			NGUITools.UpdateWidgetCollider(this, this.boxColliderCache, true);
		}
	}
	...
	public UIPanel CreatePanel()
	{
		if (this.mStarted && this.panel == null && base.enabled && NGUITools.GetActive(base.gameObject))
		{
			...
			{
				this.panel = this.storePanel;
			}
			else
			{
				this.panel = UIPanel.Find(base.cachedTransform, false, base.cachedGameObject.layer);
				this.storePanel = this.panel;
			}
			if (this.panel != null)
			{
	...
	protected override void OnInit()
	{
		...
		if (this.storePanel == null)
		{
			this.storePanel = UIPanel.Find(base.cachedTransform, false, base.cachedGameObject.layer);
		}
		base.OnInit();
		this.RemoveFromPanel();
		this.mMoved = true;
	...
	{
		if (this.panel == null && this.autoFindPanel)
		{
			this.CreatePanel();
		}
	}
