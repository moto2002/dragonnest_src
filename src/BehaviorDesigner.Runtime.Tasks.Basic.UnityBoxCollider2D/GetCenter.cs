...
{
	[TaskCategory("Basic/BoxCollider2D"), TaskDescription("Stores the center of the BoxCollider2D. Returns Success.")]
	public class GetCenter : BehaviorDesigner.Runtime.Tasks.Action
	{
		[BehaviorDesigner.Runtime.Tasks.Tooltip("The GameObject that the task operates on. If null the task GameObject is used.")]
		public SharedGameObject targetGameObject;

		[RequiredField, BehaviorDesigner.Runtime.Tasks.Tooltip("The center of the BoxCollider2D")]
		...
		public override TaskStatus OnUpdate()
		{
			...
			this.storeValue.Value = this.boxCollider2D.center;
